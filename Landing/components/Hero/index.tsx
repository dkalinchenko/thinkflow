            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  Weighted Decision Matrix & AI Product Comparison Tool
                </h1>
                <p className="mb-12 text-base !leading-relaxed text-body-color sm:text-lg md:text-xl">
                  Compare products side-by-side using a weighted decision matrix calculator with AI-powered suggestions. Make objective decisions with our selection matrix tool—no account required, completely free, and privacy-first.
                </p>
                <div className="flex flex-col items-start space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  ...
                  <Link
                    href="#features"
                    className="inline-block rounded-sm bg-black/10 px-8 py-4 text-base font-semibold text-black duration-300 ease-in-out hover:bg-black/20"
                  >
                    Learn More
                  </Link>
                </div>
