  ...
  return (
    ...
    >
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
        Stay Updated with ThinkFlow
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Get notified about new features, tips for better decision-making, and exclusive updates. Join our community of smart shoppers!
      </p>
      <div>
        <input
          type="text"
        ...
        <p className="dark:text-body-color-dark text-center text-base leading-relaxed text-body-color">
          Privacy-first, just like ThinkFlow. Unsubscribe anytime.
        </p>
      </div>
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#6366F1" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
