        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div
              ...
              "
            >
              <h2 className="mb-3 text-2xl font-bold text-black dark:text-white sm:text-3xl lg:text-3xl xl:text-3xl">
                  ...
                  <div className="w-full px-4">
                    <div className="mb-8">
                      ...
                      <textarea
                        name="message"
                        rows={5}
                        placeholder="Share your feedback, questions, or feature ideas..."
