              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Compare any products side-by-side" />
                    <List text="Customize your criteria" />
                    <List text="Weight what matters most" />
                    <List text="AI-powered suggestions" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="See results at a glance" />
                    <List text="No account needed, ever" />
                    <List text="Save and share decisions" />
                  </div>
                </div>
              </div>
            </div>
